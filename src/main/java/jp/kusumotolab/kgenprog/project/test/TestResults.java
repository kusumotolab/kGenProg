...
public class TestResults implements Serializable {
	 ...
	 * @return
	 */
	private long getNumberOfTests(final SourceFile sourceFile, final Location location, final Coverage.Status status,
			final boolean failed) {

		// 翻訳1: SourceFile → [FQN]
		final Set<FullyQualifiedName> correspondingFqns = this.buildResults.getPathToFQNs(sourceFile.path);
		...
		return correspondingFqns.stream().map(fqn -> getTestFQNs(fqn, correspondingLineNumber, status, failed))
	 ...
	 * @return
	 */
	public long getNumberOfPassedTestsExecutingTheStatement(final SourceFile sourceFile, final Location location) {
	 ...
	 * @return
	 */
	public long getNumberOfFailedTestsExecutingTheStatement(final SourceFile sourceFile, final Location location) {
	 ...
	 * @return
	 */
	public long getNumberOfPassedTestsNotExecutingTheStatement(final SourceFile sourceFile, final Location location) {
	 ...
	 * @return
	 */
	public long getNumberOfFailedTestsNotExecutingTheStatement(final SourceFile sourceFile, final Location location) {
