...
public class TestProcessBuilder {
  ...
  public void start() {
    ...
    final String sourceFiles =
        c.stream().map(f -> f.value).collect(Collectors.joining(TestExecutorMain.SEPARATOR));
    ...
    final ProcessBuilder builder = new ProcessBuilder(javaBin, "-cp", classpath, main, "-b",
        this.binDir.toString(), "-s", sourceFiles, "-t", testFiles);
   ...
   */
  @Deprecated
  public void start(final List<String> sourceClasses, final List<String> testClasses,
