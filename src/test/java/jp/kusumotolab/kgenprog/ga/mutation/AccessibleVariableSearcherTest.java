...
public class AccessibleVariableSearcherTest {
  ...
  public void test01() {
    ...
    final ASTLocation line7 = locations.get(0); // String str_1 = ""
    ...
    final ASTLocation line9 = locations.get(3); // String str_2_1, str2_2 = "";
    assertThat(searcher.exec(line9)).hasSize(7);

    final ASTLocation line11 = locations.get(5); // String str_3 = ""
    assertThat(searcher.exec(line11)).hasSize(7);

    final ASTLocation line13 = locations.get(6); // String str_4 = ""
    assertThat(searcher.exec(line13)).hasSize(7);

    final ASTLocation line15 = locations.get(7); // String str_5 = ""
    assertThat(searcher.exec(line15)).hasSize(8);

    final ASTLocation line20 = locations.get(10); // String str_6 = ""
    assertThat(searcher.exec(line20)).hasSize(5);

    final ASTLocation line22 = locations.get(11); // String str_7 = ""
  ...
  public void testForForStatement() {
    ...
    final ASTLocation location = locations.get(12); // System.out.println(i);
  ...
  public void testForEnhancedForStatement() {
    ...
    final ASTLocation location = locations.get(16); // System.out.println(string);
    final List<Variable> variables = searcher.exec(location);
